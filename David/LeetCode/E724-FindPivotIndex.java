...
Description: Given an array of integers nums, write a method that returns the "pivot" index of this
array.
...
Solution: One-pass solution. You can find the total sum and then the leftSide sum, and then
iterate through the array and try to see if the right side matches the left side.
